...
bool scene_intersect(const Vec3f &orig, const Vec3f &dir, const std::vector<Sphere> &spheres, Vec3f &hit, Vec3f &N, Material &material) {
    ...
    //     float dist_i;
    //     if (teapot.ray_triangle_intersect(i, orig, dir, dist_i) && dist_i < spheres_dist) {
    //         spheres_dist = dist_i;
    //         hit = orig + dir*dist_i;
    //         N=teapot.normal(i).normalize();
    //         material = red_rubber;
    //     }
    // }
...
void render(const std::vector<Sphere> &spheres, const std::vector<Light> &lights) {
    ...
    stbi_write_jpg("out2.jpg", width, height, 3, pixmap.data(), 100);
}
